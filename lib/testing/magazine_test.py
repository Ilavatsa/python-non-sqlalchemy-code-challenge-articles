...
class TestMagazine:
    ...
    def test_name_is_mutable_string(self):
        ...
        # Test that setting name to an invalid value raises an exception
    ...
    def test_name_len(self):
        ...
        # Test that setting name to an invalid length raises an exception
        with pytest.raises(ValueError):
    ...
    def test_category_is_mutable_string(self):
        ...
        # Test that setting category to an invalid value raises an exception
        with pytest.raises(ValueError):
    ...
    def test_category_len(self):
        ...
        # Test that setting category to an empty string raises an exception
        with pytest.raises(ValueError):
            magazine_1.category = ""
